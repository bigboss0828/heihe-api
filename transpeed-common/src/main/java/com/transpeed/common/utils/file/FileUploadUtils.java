...
import com.transpeed.common.exception.file.FileNameLengthLimitExceededException;
import com.transpeed.common.exception.file.FileSizeLimitExceededException;
import com.transpeed.common.exception.file.InvalidExtensionException;
import com.transpeed.common.utils.DateUtils;
import com.transpeed.common.utils.StringUtils;
import com.transpeed.common.utils.uuid.IdUtils;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = Transpeed.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = Transpeed.getProfile().length() + 1;
