package com.transpeed.framework.aspectj;

import com.alibaba.fastjson2.JSON;
import com.transpeed.common.annotation.Log;
import com.transpeed.common.constant.business.system.operlog.OperLogStatus;
...
public class LogAspect {
     ...
     * @param joinPoint 切点
     */
    @AfterReturning(pointcut = "@annotation(controllerMethodPointcut)", returning = "jsonResult")
    public void doAfterReturning(JoinPoint joinPoint, Log controllerMethodPointcut, Object jsonResult) {
        handleLog(joinPoint, controllerMethodPointcut, null, jsonResult);
    }
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        ...
        operLog.setOperStatus(OperLogStatus.SUCCESS.getCode());
        ...
        if (e != null) {
            operLog.setOperStatus(OperLogStatus.FAIL.getCode());
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLogEntity operLog, Object jsonResult) throws Exception {
        ...
        // 设置标题
        operLog.setTitle(log.title().ordinal());
        // 是否需要保存request，参数和值
